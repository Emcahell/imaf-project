document.addEventListener("DOMContentLoaded", function () {
  ...
  function showPendientes() {
    ...
    document
      .querySelectorAll(
        ".box-card-aprobados, .box-card-rechazados, .box-card-todos"
      )
  ...
  function showAprobados() {
    ...
    document
      .querySelectorAll(
        ".box-card-pendientes, .box-card-rechazados, .box-card-todos"
      )
      .forEach((card) => (card.style.display = "none"));
  }
  ...
  function showRechazados() {
    ...
    document
      .querySelectorAll(
        ".box-card-pendientes, .box-card-aprobados, .box-card-todos"
      )
      .forEach((card) => (card.style.display = "none"));
  }
  ...
  function showTodos() {
    ...
    document
      .querySelectorAll(
        ".box-card-pendientes, .box-card-aprobados, .box-card-rechazados"
      )
      .forEach((card) => (card.style.display = "none"));
  }
