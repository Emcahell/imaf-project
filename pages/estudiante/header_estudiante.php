...
// Recibe: $numNotificaciones y $qNotificaciones desde cursos.php
?>
...
<header>
  ...
  <div class="tools">
    <p>Estudiante <span id="conexion">•</span></p>
    <span class="icon-notification" id="notif-icon" style="position:relative;cursor:pointer;">
      ...
      <?php endif; ?>
      <svg class="icon" id="icon-notification" viewBox="0 0 448 512" style="height:28px;vertical-align:middle;">
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const openBtn = document.getElementById('open-modal-edit');
  ...
  if (notifIcon && notifDropdown) {
    ...
    notifDropdown.addEventListener('click', function(e) {
      e.stopPropagation(); // Para que no se cierre al hacer click dentro del dropdown
    });
  }
});
</script>
